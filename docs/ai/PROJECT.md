...
## Status
Production (Maungano live deposits confirmed 2026-09-19). Version 2.3.0 (admin attempts + cached /active-conf).
...
## Frontend
Checkout CSS/JS; thank-you / order-pay waiting card + adaptive poll JS. Classic checkout.
