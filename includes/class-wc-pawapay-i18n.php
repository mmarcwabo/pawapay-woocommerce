...
class WC_PawaPay_I18n {
    ...
    public static function filter_french( string $translation, string $text ): string {
        ...
        $map = [
            ...
            'Confirm the payment on your phone. Do not pay again.' => 'Confirmez le paiement sur votre téléphone. Ne payez pas une seconde fois.',
            'Payment confirmed. This page will refresh.' => 'Paiement confirmé. Cette page va se recharger.',
            'This order can no longer be paid here. Open the order or contact the shop.' => 'Cette commande ne peut plus être payée ici. Ouvrez la commande ou contactez la boutique.',
            'That payment did not complete. You can try another number from the pay page.' => 'Ce paiement n’a pas abouti. Vous pouvez essayer un autre numéro depuis la page de paiement.',
            'Still waiting for confirmation. Keep this page open or check the order later.' => 'Toujours en attente de confirmation. Laissez cette page ouverte ou consultez la commande plus tard.',
            'Try another number' => 'Essayer un autre numéro',
            'Approve the payment on %1$s for the number ending %2$s.' => 'Validez le paiement sur %1$s pour le numéro se terminant par %2$s.',
            'your mobile money wallet' => 'votre portefeuille mobile money',
            'Confirm on your phone' => 'Confirmez sur votre téléphone',
            'Payment not available' => 'Paiement indisponible',
            'PawaPay attempts' => 'Tentatives PawaPay',
            'Each row is one PawaPay deposit. Phone numbers are masked. Check status runs a merchant GET.' => 'Chaque ligne est un dépôt PawaPay. Les numéros sont masqués. « Vérifier le statut » lance un GET marchand.',
            'No PawaPay attempts on this order.' => 'Aucune tentative PawaPay sur cette commande.',
            'You are not allowed to view payment attempts.' => 'Vous n’êtes pas autorisé à voir les tentatives de paiement.',
            'You are not allowed to check PawaPay status.' => 'Vous n’êtes pas autorisé à vérifier le statut PawaPay.',
            'PawaPay status checked.' => 'Statut PawaPay vérifié.',
            'That payment attempt was not found.' => 'Cette tentative de paiement est introuvable.',
            'No payment attempts yet.' => 'Aucune tentative de paiement pour le moment.',
